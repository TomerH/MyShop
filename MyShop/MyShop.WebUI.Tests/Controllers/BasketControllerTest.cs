...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "fakeUser@gmail.com", ZipCode = "99999" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("fakeUser@gmail.com", "Forms"), null);
